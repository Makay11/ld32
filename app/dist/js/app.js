...
var C69, Enemy, EnemyManager, Entity, GameManager, Minibot, Player, Road, defer, keyCodes,
...
Entity = (function() {
  function Entity(renderer, textureURL1, horizontalTiles) {
    ...
    THREEx.Transparency.init([this.mesh]);
  }
...
GameManager = (function() {
  ...
  GameManager.prototype.createScene = function() {
    ...
    return this.enemyManager = new EnemyManager(this.renderer, this.scene);
  };
  ...
  GameManager.prototype.update = function(delta) {
    ...
    return this.enemyManager.update(delta, this.player, this.camera);
  };
...
Enemy = (function(superClass) {
  ...
  function Enemy(renderer, textureName) {
    Enemy.__super__.constructor.call(this, renderer, "/images/" + textureName + ".png");
...
C69 = (function(superClass) {
  ...
  function C69(renderer, color) {
    this.color = color;
    C69.__super__.constructor.call(this, renderer, "c69_" + this.color);
    this.type = "c69";
  }
...
Minibot = (function(superClass) {
  ...
  function Minibot(renderer, color) {
    this.color = color;
    Minibot.__super__.constructor.call(this, renderer, "minibot_" + this.color);
    this.type = "minibot";
  }
...
EnemyManager = (function() {
  ...
  EnemyManager.prototype.stashEnemy = function(enemy) {
    ...
    this.enemyPool[enemy.type][enemy.color].push(enemy);
    return enemy.reset();
  };
