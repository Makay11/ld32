...
defer(function() {
  var camera, enemies, enemyPool, gameLoop, generateNextSpawn, geometry, height, keyCodes, material, movementQueue, nextSpawn, plane, player, previousTime, render, renderer, scene, transparentObjects, update, updateEnergy, width;
