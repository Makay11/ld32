...
var C69, Enemy, EnemyManager, Entity, GameManager, Minibot, Player, Road, components, keyCodes,
...
(function() {
  ...
  generateComponents = function(textureURL) {
    return {
      material: new THREE.MeshBasicMaterial({
        map: Entity.prototype.loadTexture(textureURL)
      }),
      geometry: geometry
    };
  };
